...
ActiveRecord::Schema.define(version: 2021_08_14_122619) do
  ...
  create_table "orders", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "purchased_id", null: false
    ...
    t.integer "area_id", null: false
    t.index ["purchased_id"], name: "index_orders_on_purchased_id"
  end
  ...
  add_foreign_key "orders", "purchaseds"
  add_foreign_key "purchaseds", "items"
